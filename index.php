...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logo/software.png">
    <link rel="apple-touch-icon-precomposed" href="assets/images/logo/software.png">
</head>
                    ...
                    <div class="swiper tf-sw-top_bar" data-preview="1" data-space="0" data-loop="true" data-speed="1000" data-delay="2000">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <p class="top-bar-text fw-5 text_white">Impulsa tu negocio con un software a medida. <a href="shop-default.html" title="all collection" class="tf-btn btn-line">Contáctanos<i class="icon icon-arrow1-top-left"></i></a></p>
                            </div>
                            <div class="swiper-slide">
                                <p class="top-bar-text fw-5 text_white">Soluciones tecnológicas para cualquier industria. <a href="shop-default.html" title="all collection" class="tf-btn btn-line">Descubre más<i class="icon icon-arrow1-top-left"></i></a></p>
                            </div>
                            <div class="swiper-slide">
                ...
                <div class="col-xl-6 tf-md-hidden">
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                            <li class="menu-item">
                                <a href="#" class="item-link">Inicio<i class="icon icon-arrow-down"></i></a>
                            </li>
                            <li class="menu-item">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide" lazy="true">
                    <div class="wrap-slider">
                        <img class="lazyload" data-src="assets/images/slider/Slideshow_Electronics1.jpg" src="assets/images/slider/Slideshow_Electronics1.jpg" alt="fashion-slideshow-01">
        ...
        <div class="container">
            <div class="tf-grid-layout gap-0 md-col-2 bg_primary tf-img-with-text style-5">
                <div class="tf-image-wrap wow fadeInUp" data-wow-delay="0s">
                    <img class="lazyload" data-src="assets/images/collections/collection-72.jpg" src="assets/images/collections/collection-72.jpg" alt="collection-img">
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide height-auto" lazy="true">
                            <div class="card-product overflow-hidden bg_white radius-20 border-line h-100">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" src="assets/images/collections/electronic-12.png" data-src="assets/images/collections/electronic-12.png" alt="image-product">
                                        <img class="lazyload img-hover" data-src="assets/images/collections/electronic-13.png" src="assets/images/collections/electronic-13.png" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                        ...
                        <div class="swiper-slide height-auto" lazy="true">
                            <div class="card-product overflow-hidden bg_white radius-20 border-line h-100">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" src="assets/images/collections/electronic-14.png" data-src="assets/images/collections/electronic-14.png" alt="image-product">
                                        <img class="lazyload img-hover" data-src="assets/images/collections/electronic-15.png" src="assets/images/collections/electronic-15.png" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                        ...
                        <div class="swiper-slide height-auto" lazy="true">
                            <div class="card-product overflow-hidden bg_white radius-20 border-line h-100">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" src="assets/images/collections/electronic-16.jpg" data-src="assets/images/collections/electronic-16.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="assets/images/collections/electronic-17.jpg" src="assets/images/collections/electronic-17.jpg" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                        ...
                        <div class="swiper-slide height-auto" lazy="true">
                            <div class="card-product overflow-hidden bg_white radius-20 border-line h-100">
                                <div class="card-product-wrapper">
                                    <a href="product-detail.html" class="product-img">
                                        <img class="lazyload img-product" src="assets/images/collections/electronic-18.jpg" data-src="assets/images/collections/electronic-18.jpg" alt="image-product">
                                        <img class="lazyload img-hover" data-src="assets/images/collections/electronic-19.jpg" src="assets/images/collections/electronic-19.jpg" alt="image-product">
                                    </a>
                                    <div class="list-product-btn absolute-2">
                                        <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                            <span class="icon icon-bag"></span>
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="assets/images/collections/electronic-16.jpg" src="assets/images/collections/electronic-16.jpg" alt="">
                                        </a>
                                    </div>
                        ...
                        <div class="swiper-slide height-auto">
                            <div class="testimonial-item h-100 bg_white style-column wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="assets/images/collections/electronic-12.png" src="assets/images/collections/electronic-12.png" alt="">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="product-title">
                        ...
                        <div class="swiper-slide height-auto">
                            <div class="testimonial-item h-100 bg_white style-column wow fadeInUp" data-wow-delay=".2s">
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="assets/images/collections/electronic-8.png" src="assets/images/collections/electronic-8.png" alt="">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="product-title">
                        ...
                        <div class="swiper-slide height-auto">
                            <div class="testimonial-item h-100 bg_white style-column wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="assets/images/collections/electronic-10.png" src="assets/images/collections/electronic-10.png" alt="">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="product-title">
    ...
    <section class="flat-spacing-14">
        <div class="container">
            ...
            <div class="hover-sw-nav view-default hover-sw-3">
                <div class="swiper tf-sw-product-sell" data-preview="3" data-tablet="2" data-mobile="1" data-space-lg="30" data-space-md="30" data-space="15" data-pagination="1" data-pagination-md="1" data-pagination-lg="1">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay="0s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-1.jpg" src="assets/images/blog/electronic-1.jpg" alt="img-blog">
                                    </a>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay=".1s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-2.jpg" src="assets/images/blog/electronic-2.jpg" alt="img-blog">
                                    </a>
                                    <div class="article-label">
                                        <a href="blog-grid.html" class="tf-btn btn-sm animate-hover-btn">Accessories</a>
                                    </div>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay=".2s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-3.jpg" src="assets/images/blog/electronic-3.jpg" alt="img-blog">
                                    </a>
                                    <div class="article-label">
                                        <a href="blog-grid.html" class="tf-btn btn-sm animate-hover-btn">Accessories</a>
                                    </div>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay=".3s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-4.jpg" src="assets/images/blog/electronic-4.jpg" alt="img-blog">
                                    </a>
                                    <div class="article-label">
                                        <a href="blog-grid.html" class="tf-btn btn-sm animate-hover-btn">Accessories</a>
                                    </div>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay=".4s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-5.jpg" src="assets/images/blog/electronic-5.jpg" alt="img-blog">
                                    </a>
                                    <div class="article-label">
                                        <a href="blog-grid.html" class="tf-btn btn-sm animate-hover-btn">Accessories</a>
                                    </div>
                        ...
                        <div class="swiper-slide" lazy="true">
                            <div class="blog-article-item wow fadeInUp" data-wow-delay=".5s">
                                <div class="article-thumb h-460 rounded-0">
                                    <a href="blog-detail.html">
                                        <img class="lazyload" data-src="assets/images/blog/electronic-6.jpg" src="assets/images/blog/electronic-6.jpg" alt="img-blog">
                                    </a>
                                    <div class="article-label">
                                        <a href="blog-grid.html" class="tf-btn btn-sm animate-hover-btn">Accessories</a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                                <div class="footer-menu_item">© 2025 FabriStore. Todos los derechos reservados.</div>
        ...
        <div class="modal-content">
            ...
            <div class="tf-rte">
                ...
                <div class="tf-page-size-chart-content">
                    ...
                    <div>
                        <img class="sizechart lazyload" data-src="images/shop/products/size_chart2.jpg" src="assets/images/shop/products/size_chart2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
